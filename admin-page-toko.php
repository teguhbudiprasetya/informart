...
<body>
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-10">
            <div class="row">
                <div class="col-1">
                    <a href="admin-page-toko.php?id=<?=$sellerID?>">    
                            ...
                            foreach($kategori as $row){
                                if(isset($_GET['kategori'])){
                                    if($_GET['kategori'] == $row['kategori']){
                                        echo"<li><a href='admin-page-toko.php?id=$sellerID&kategori=$row[kategori]' style='color:#007bff''>$row[kategori]</a></li>";
                                    }else{
                                        echo"<li><a href='admin-page-toko.php?id=$sellerID&kategori=$row[kategori]'>$row[kategori]</a></li>";
                                    }
                                }else{
                                    echo"<li><a href='admin-page-toko.php?id=$sellerID&kategori=$row[kategori]'>$row[kategori]</a></li>";
                                }
